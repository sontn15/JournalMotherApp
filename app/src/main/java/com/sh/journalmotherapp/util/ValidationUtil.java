...
public class ValidationUtil {
    ...
    public static boolean isPostTitleValid(String name) {
        return name.length() <= Const.Post.MAX_POST_TITLE_LENGTH;
    }

    public static boolean isNameValid(String name) {
        return name.length() <= Const.Profile.MAX_NAME_LENGTH;
    }
    ...
    public static boolean checkImageMinSize(Rect rect) {
        return rect.height() >= Const.Profile.MIN_AVATAR_SIZE && rect.width() >= Const.Profile.MIN_AVATAR_SIZE;
    }
}
