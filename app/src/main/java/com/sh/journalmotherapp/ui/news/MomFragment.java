...
public class MomFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        root = inflater.inflate(R.layout.fragment_mom_life, container, false);
        initData();
        initView();
        initAdapter();
    ...
    private void initView() {
        rcvView = root.findViewById(R.id.rcvMom);
    ...
    private void getAllPosts() {
        if (NetworkUtils.haveNetwork(requireContext())) {
            Call<List<NewsEntity>> call = apiService.getAllNews(NewsCategoryEnum.MOM.getName());
